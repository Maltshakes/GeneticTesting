package net.maltshakes.genetesting;
...
import net.maltshakes.genetesting.genes.handler.AnimalResolver;
import net.maltshakes.genetesting.item.*;
import net.maltshakes.genetesting.utils.GeneHelpers;
...
@Mod(GeneTesting.MOD_ID)
public class GeneTesting {
    // Define mod id
    public static final String MOD_ID = "genetesting";
    // Directly reference a slf4j logger
    private static final Logger LOGGER = LogUtils.getLogger();

    public GeneTesting(FMLJavaModLoadingContext context) {
    ...
    /**
     * Handler for the GeneBook. This is the main handler where all
     * functionality relating to the GeneBook is being handled.
     * GeneBooks are created by using a vanilla Minecraft book
     * and interacting with a LivingEntity that has the 'Genetics'
     * NBT tag.
     */
                    ...
                    if (entityNBT.contains("Genetics")) {
                        ...
                        if (geneBook.getItem() instanceof GeneBookItem geneItem) {
                            ...
                            if (agenes != null) {
                                ...
                                List<BookEntry> bookEntries = AnimalResolver.resolveAllEntries(entityType, agenes, sgenes, isFemale);
                                ...
                                // Else add new geneBook to the inventory. If inventory full, drop geneBook on ground
                                } else {

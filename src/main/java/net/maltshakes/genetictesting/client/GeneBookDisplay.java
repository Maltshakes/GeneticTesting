...
public class GeneBookDisplay {
   ...
   * headers with underline and comments with italics. Automatic column wrapping after 12 lines, set
   * to COLUMN_SIZE. Handling manual page and column breaks via metadata tags.
   *
          ...
          for (int j = 0; j < lines.size(); j++) {
            ...
            lines
                ...
                .accept(
                    (index, style, codePoint) -> {
                      wrappedLine.append(
                          Component.literal(String.valueOf((char) codePoint)).withStyle(style));
                      return true;
                    });

...
public class ChickenGeneFormat extends GeneFormatting {
  ...
  private static final List<String> CHICKEN_GOLD_GENES =
      List.of(
          "0",
          "g", // gold
          "s" // silver
  ...
  private static final List<String> CHICKEN_DOMWHITE_GENES =
      List.of(
          "0",
          "I", // Dom White
          "+", // Wildtype
  ...
  private static final List<String> CHICKEN_RECWHITE_GENES =
      List.of(
          "0",
          "+", // Wildtype
          "c", // Recessive White
  ...
  private static final List<String> CHICKEN_MOTTLED_GENES =
      List.of(
          "0",
          "+", // Wildtype
          "mo", // Mottled
  ...
  private static final List<String> CHICKEN_EXTENSION_GENES =
      List.of(
          "0",
          "R", // Birchen
          "+", // Duckwing/Wildtype
  ...
  private static final List<String> CHICKEN_DILUTE_GENES =
      List.of(
          "0",
          "Di", // Dilute
          "Cr", // Cream
  ...
  private static final List<String> CHICKEN_YELSHANK_GENES =
      List.of(
          "0",
          "w", // White
          "y", // Yellow
  ...
  public ChickenGeneFormat() {
    ...
    addSexLinkedPairMapping(
        "Fibro Supressor", "f", GeneType.BINARY, 4); // [8, 9] // Fibromelanin Suppressor
    // Males work same as AGenes. Females carry have two alleles for each locus, but only the first
    // allele of each pair is used for females, second one is ignored.
    addLineBreak();
    addComment("Autosomal Genes");
    addPairMapping(
        "Extension",
        CHICKEN_EXTENSION_GENES,
        GeneType.POLYMORPHIC,
        12); // [24,25] - D Locus / Extension
    addPairMapping(
        "Dom. white", CHICKEN_DOMWHITE_GENES, GeneType.POLYMORPHIC, 19); // [38,39] - Dominant white
    addPairMapping(
        "Rec. white",
        CHICKEN_RECWHITE_GENES,
        GeneType.POLYMORPHIC,
        10); // [20,21] - Recessive white
    ...
    addPairMapping(
        "Yellow Shanks",
        CHICKEN_YELSHANK_GENES,
        GeneType.POLYMORPHIC,
        22); // [44,45] - Yellow Shanks
    addPairMapping(
        "Rec. Black Shanks", "bl", GeneType.BINARY, 83); // [166,167] - Recessive Black Shanks

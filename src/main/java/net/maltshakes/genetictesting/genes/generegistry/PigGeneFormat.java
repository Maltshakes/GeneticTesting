...
public class PigGeneFormat extends GeneFormatting {
  ...
  private static final List<String> PIG_EXTENSION_GENES =
      List.of(
          "0",
          "D1", // Dom Black (MCR1)
          "E", // Wildtype
  ...
  private static final List<String> PIG_AGOUTI_GENES =
      List.of(
          "0",
          "A", // Wildtype
          "B", // Legacy Brown
  ...
  private static final List<String> PIG_TYRP1_GENES =
      List.of(
          "0",
          "+", // No dilute
          "B", // Silver-brown
  ...
  private static final List<String> PIG_KIT_GENES =
      List.of(
          "0",
          "LI", // Legacy Dom White
          "Be", // Belted
  ...
  private static final List<String> PIG_WP_GENES =
      List.of(
          "0",
          "+", // Wildtype
          "LT", // Legacy Tuxedo
  ...
  private static final List<String> PIG_WE_GENES =
      List.of(
          "0",
          "-", // Undermarked
          "0", // Medium
  ...
  private static final List<String> PIG_DESAT_SCALE =
      List.of(
          "Min",
          "Near Min",
          "Very Low",
  ...
  private static final List<String> PIG_DARKNESS_SCALE =
      List.of("Min", "Near Min", "Low", "Med-Low", "Medium", "Med-High", "High", "Near Max", "Max");

  private static final List<String> PIG_RUFOUS_SCALE =
      List.of(
          "Min", // -14
          "Near Min",
          "Near Min", // -13 -12
  ...
  public PigGeneFormat() {
    ...
    addPairMapping(
        "White Extension", PIG_WE_GENES, GeneType.POLYMORPHIC, 8); // [16,17] - White Extension

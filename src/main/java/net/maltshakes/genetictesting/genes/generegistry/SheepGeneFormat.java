...
public class SheepGeneFormat extends GeneFormatting {
  ...
  private static final List<String> SHEEP_AGOUTI_GENES =
      List.of(
          "0",
  ...
  private static final List<String> SHEEP_EXTENSION_GENES =
      List.of(
          "0",
          "D", // Dominant Black
          "+", // Wildtype
  ...
  private static final List<String> SHEEP_PIGMENTED_HEAD_GENES =
      List.of(
          "0",
          "+", // Wildtype
          "AFL", // Afghan Lethal
  ...
  private static final List<String> SHEEP_REDINHIB_GENES =
      List.of(
          "0",
          "+", // Wildtype
          "Da", // Darker
  ...
  private static final List<String> SHEEP_BLAZE_GENES =
      List.of(
          "0",
          "+", // Wildtype
          "n", // Nadji
  ...
  private static final List<String> SHEEP_RUFOUS_SCALE =
      List.of(
          "Min", // -8
          "Near Min", // -7
          "Ultra Low", // -6
  ...
  public SheepGeneFormat() {
    ...
    addPairMapping(
        "Extension", SHEEP_EXTENSION_GENES, GeneType.POLYMORPHIC, 2); // [4,5] - Extension
    ...
    addPairMapping(
        "Red Inhibitors",
        SHEEP_REDINHIB_GENES,
        GeneType.POLYMORPHIC,
        36); // [72,73] - Red inhibitors
    addPolyScaleMapping(
        "Rufousing",
        SHEEP_RUFOUS_SCALE,
    ...
    addPairMapping(
        "Pigmented Head",
        SHEEP_PIGMENTED_HEAD_GENES,
        GeneType.POLYMORPHIC,
        34); // [68,69] - Pigmented Head
    addPairMapping("Roan", "Rn", GeneType.BINARY, 50); // [100,101] - Roan
    addLineBreak();
    addConditionalComment(
        "AFL is homo lethal! Sheep with two copies of the gene die at birth",
        34,
        (v1, v2) -> v1 == 2 || v2 == 2);
    addConditionalComment(
        "Rn is homo lethal! Sheep with two copies of the gene die at birth",
        50,
        (v1, v2) -> v1 == 2 || v2 == 2);
  }
}

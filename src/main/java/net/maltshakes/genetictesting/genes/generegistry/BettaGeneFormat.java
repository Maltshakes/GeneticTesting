...
public class BettaGeneFormat extends GeneFormatting {
  ...
  private static final List<String> BETTA_NONRED_GENES =
      List.of(
          "0",
          "Nr", // Wildtype
          "nr2", // Orange
  ...
  private static final List<String> BETTA_MARBLE_GENES =
      List.of(
          "0",
          "+", // Wildtype
          "mb", // Marble
  ...
  private static final List<String> BETTA_MARBLE_SIZE_SCALE =
      List.of(
          "Min", // -4
          "Near Min", // -3
          "Super Low", // -2
  ...
  private static final List<String> BETTA_RUFOUSING_SCALE =
      List.of(
          "Min", // -10
          "Near Min", // -9
          "Ultra Low", // -8
  ...
  private static final List<String> BETTA_IRI_HUE_SCALE =
      List.of(
          "Lightest", // -10
          "Near Lightest", // -9
          "Ultra Light", // -8
  ...
  private static final List<String> BETTA_LOW_HIGH_LEVEL_SCALE =
      List.of("Min", "Low", "Medium", "High", "Max");

  private static final List<String> BETTA_MASK_IRI_SCALE =
      List.of("Min", "Near Min", "Low", "Medium", "High", "Near Max", "Max");

  private static final List<String> BETTA_IRI_INTENSITY_SCALE =
      List.of("Min", "Near Min", "Low", "Medium", "High", "Near Max", "Max");

  private static final List<String> BETTA_HIGH_LOW_LEVEL_SCALE =
      List.of("Max", "High", "Medium", "Low", "Min");

  private static final List<String> BETTA_MARBLE_QUALITY_SCALE =
      List.of(
          "Min", // value: 4
          "Near Min", // 5
          "Ultra Low", // 6
  ...
  public BettaGeneFormat() {
    ...
    addPolyRangeMapping(
        "Body Iri Area", BETTA_LOW_HIGH_LEVEL_SCALE, 24, 27); // [20-23] Body Iri Level
    addPolyRangeMapping(
        "Fin Iri Area", BETTA_LOW_HIGH_LEVEL_SCALE, 28, 31); // [20-23] Fin Iri Level
    addPairMapping("Iri Rims", "R", GeneType.BINARY, 33); // [66,67] - Iri rims
    addPolyRangeMapping(
        "Iri Rim Level", BETTA_LOW_HIGH_LEVEL_SCALE, 68, 71); // [50-55] Iri Rims Level
    ...
    addCustomBettaPolyScaleMapping(
        "Iri intensity", BETTA_IRI_INTENSITY_SCALE, new int[] {32, 33}, new int[] {34, 35});
    ...
    addPairMapping(
        ...
        "m",
        GeneType.BINARY,
        3); // [6,7] - Melano Black (homo females are infertile)
    ...
    addPairMapping(
        "Metallic", "nm", GeneType.BINARY_INVERTED, 24); // [48,49] - Metallic + / Non-metallic nm
    ...
    addPairMapping(
        "Marble", BETTA_MARBLE_GENES, GeneType.POLYMORPHIC, 40); // [80,81] - Marble/Vanda
    addPairMapping("Butterfly", "B", GeneType.BINARY, 9); // [18,19] - Butterfly

    addPolyRangeMapping(
        "Butterfly Level", BETTA_LOW_HIGH_LEVEL_SCALE, 20, 23); // [20-23] Butterfly Level
    // Red Marble Layer
    addPolyScaleMapping(
        "Red Marble Size",
        BETTA_MARBLE_SIZE_SCALE,
        IntStream.rangeClosed(82, 85).toArray(), // [82,85] -red marble
        IntStream.rangeClosed(86, 91).toArray() // [86,91] +red marble
        );
    addPolyRangeMapping(
        "Red Marble Quality",
        BETTA_MARBLE_QUALITY_SCALE,
        92,
        95,
        5); // [92-95] Red marble quality scale
    addPolyScaleMapping(
        "Red Body Area",
        BETTA_HIGH_LOW_LEVEL_SCALE,
        IntStream.rangeClosed(44, 45).toArray(), // [44,45] +body red area
        IntStream.rangeClosed(46, 47).toArray() // [46,47] -body red area
        );
    addPolyRangeMapping(
        "Red Fin Area", BETTA_HIGH_LOW_LEVEL_SCALE, 36, 39); // [36-39] Fin Red Level
    addPolyScaleMapping(
        "Rufousing",
        BETTA_RUFOUSING_SCALE,
    ...
    addPolyRangeMapping(
        "Black Marble Quality",
        BETTA_MARBLE_QUALITY_SCALE,
        106,
        109,
        5); // [106-109] Black marble quality scale
    ...
    addPolyRangeMapping(
        ...
        120,
        123,
        5); // [120-123] Bloodred marble quality scale
    addPolyScaleMapping(
        "Body Bloodred Area",
        BETTA_HIGH_LOW_LEVEL_SCALE,
    ...
    addPolyRangeMapping(
        "Bloodred Fin Area", BETTA_HIGH_LOW_LEVEL_SCALE, 158, 161); // [158-161] Fin Bloodred Level
    addPolyScaleMapping(
        "Bloodred Rufousing",
        BETTA_RUFOUSING_SCALE,
    ...
    addPolyRangeMapping(
        ...
        134,
        137,
        5); // [134-137] Iri marble quality scale
    // Opaque Marble Layer
    addPolyScaleMapping(
        "Opaque Marble Size",
        BETTA_MARBLE_SIZE_SCALE,
    ...
    addPolyRangeMapping(
        "Opaque Marble Quality",
        BETTA_MARBLE_QUALITY_SCALE,
        148,
        151,
        5); // [148-151] Opaque marble quality scale
  }
}

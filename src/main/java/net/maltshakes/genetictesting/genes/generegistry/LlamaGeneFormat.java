...
public class LlamaGeneFormat extends GeneFormatting {
  ...
  private static final List<String> LLAMA_EXTENSION_GENES =
      List.of(
          "0",
          "D", // Dom Black
          "+", // Wildtype
  ...
  private static final List<String> LLAMA_AGOUTI_GENES =
      List.of(
          "0",
          "pf", // Pale Shaded Fawn
          "+", // Wildtype
  ...
  public LlamaGeneFormat() {
    ...
    addPairMapping(
        "Extension", LLAMA_EXTENSION_GENES, GeneType.POLYMORPHIC, 7); // [14,15] - Extension
